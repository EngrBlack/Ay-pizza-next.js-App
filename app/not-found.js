...
export default function NotFound() {
  return (
    <div className="flex flex-col gap-3 text-center  mx-auto sm:w-5/6 min-h-screen justify-center items-center text-brown-400">
      ...
      <Link
        href="/"
        className="
        my-4 shadow-lg hover:-translate-y-0.5 active:translate-y-0 active:shadow-sm
